...
class U2Net(nn.Layer):
    ...
    def __init__(self, num_classes, in_ch=1, pretrained=None):
...
class U2Netp(nn.Layer):
    ...
    def __init__(self, num_classes, in_ch=1, pretrained=None):
        ...
        self.stage2 = RSU6(8, 8, 8)
        self.pool23 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.stage3 = RSU5(8, 8, 8)
        self.pool34 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.stage4 = RSU4(8, 8, 8)
        self.pool45 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.stage5 = RSU4F(8, 8, 8)
        self.pool56 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.stage6 = RSU4F(8, 8, 8)

        # decoder
        self.stage5d = RSU4F(16, 8, 8)
        self.stage4d = RSU4(16, 8, 8)
        self.stage3d = RSU5(16, 8, 8)
        self.stage2d = RSU6(16, 8, 8)
        self.stage1d = RSU7(16, 8, 8)

        self.side1 = nn.Conv2D(8, num_classes, 1, padding=0)
        self.side2 = nn.Conv2D(8, num_classes, 1, padding=0)
        self.side3 = nn.Conv2D(8, num_classes, 1, padding=0)
        self.side4 = nn.Conv2D(8, num_classes, 1, padding=0)
        self.side5 = nn.Conv2D(8, num_classes, 1, padding=0)
        self.side6 = nn.Conv2D(8, num_classes, 1, padding=0)
...
class ConvBNLayer(nn.Layer):
    def __init__(self,
        ...
        self._batch_norm = nn.BatchNorm2D(out_ch)
...
class RSU7(nn.Layer):  #UNet07DRES(nn.Layer):
    def __init__(self, in_ch=1, mid_ch=12, out_ch=1):
        ...
        self.rebnconvin = DepthwiseSeparable(in_ch, out_ch)

        self.rebnconv1 = DepthwiseSeparable(out_ch, mid_ch)
        self.pool1 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.rebnconv2 = DepthwiseSeparable(mid_ch, mid_ch)
        self.pool2 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.rebnconv3 = DepthwiseSeparable(mid_ch, mid_ch)
        self.pool3 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.rebnconv4 = DepthwiseSeparable(mid_ch, mid_ch)
        self.pool4 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.rebnconv5 = DepthwiseSeparable(mid_ch, mid_ch)
        self.pool5 = nn.MaxPool2D(2, stride=2, ceil_mode=True)

        self.rebnconv6 = DepthwiseSeparable(mid_ch, mid_ch)

        self.rebnconv7 = DepthwiseSeparable(mid_ch, mid_ch)

        self.rebnconv6d = DepthwiseSeparable(mid_ch * 2, mid_ch)
        self.rebnconv5d = DepthwiseSeparable(mid_ch * 2, mid_ch)
        self.rebnconv4d = DepthwiseSeparable(mid_ch * 2, mid_ch)
        self.rebnconv3d = DepthwiseSeparable(mid_ch * 2, mid_ch)
        self.rebnconv2d = DepthwiseSeparable(mid_ch * 2, mid_ch)
        self.rebnconv1d = DepthwiseSeparable(mid_ch * 2, out_ch)
